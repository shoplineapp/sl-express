...
/*
 * The App class acts as the motherboard of the whole app. It controls phases.
 * It's expected to be subclass-ed and overrided the phases.
 */
...
class App {
  ...
  /*
   * A getter of the express instance.
   * We do a lazy loading here so that it wont require the express if unnecessary
   *
   * @method expressApp
   *
  ...
  /*
   * A getter of the mongoose library. It will try to get the mongoose from MongooseModel
   * Most of the case, you'll need MongooseModel for your project
   *
   * @method mongoose
   *
  ...
  /*
   * load the config to the app. It first find the .env file and exports every variable to ENV. Then it load configs from the framework config folder and the project config folder afterwards
   *
   * @method loadConfig
   *
  ...
  /*
   * load the framework related components. Basically just something must be loaded, configurated and exported first
   *
  ...
  /*
   * load the services from framework first and then followed by project services. Also exports them to global
   *
   * @method loadServices
   *
   * @return {App} the app instance
  ...
  /*
   * load the models from project models folder. Also exports them to global
   *
   * @method loadModels
   *
   * @return {App} the app instance
  ...
  /*
   * load the view models from project models folder. Also exports them to global
   *
  ...
  /*
   * load the middlewares from framework first and then followed by project middlewares. Also exports them to global
   *
  ...
  /*
   * load the controllers from project controller folder. Also exports them to global
   *
  ...
  /*
   * making use of the framework Router model to do the routing of express
   *
   * @method loadRoute
   *
   * @return {App} the app instance
  ...
  /*
   * the standard way to connect mongo. ONLY put this in the connectDependencies method if neccessary
   *
   * @method connectMongo
   *
   * @return {App} the app instance
  ...
  /*
   * the standard way to disconnect mongo. ONLY put this in the disconnectDependencies method if neccessary
   *
  ...
  /*
   * the standard way to connect the message queue. ONLY put this in the connectDependencies method if neccessary
   *
  ...
  /*
   * the standard way to disconnect the message queue. ONLY put this in the disconnectDependencies method if neccessary
   *
  ...
  /*
   * the standard way to connect the redis. ONLY put this in the connectDependencies method if neccessary
   *
   * @method connectRedis
   *
   * @return {App} the app instance
  ...
  /*
   * the standard way to disconnect the redis. ONLY put this in the disconnectDependencies method if neccessary
   *
  ...
  /*
   * To start an express server. It receives variable by config.app
   *
   * @method startExpress
   *
  ...
  /*
   * the prepare phase intends to load all the file and exports them to a correct context so that the other phases can use the stuff later on
   *
   * @method prepare
   *
   * @return {App} the app instance
  ...
  /*
   * this phase intends to centralize all the connection to services here. Please do all the connection within this phase. Beware of the connection sequence
   *
  ...
  /*
   * this phase intends to centralize all the disconnection from services here. Please do all the connection within this phase
  ...
  /*
   * the start service phase is the phase that you start what your application actaully doing. By default, we set it to start an express server.
   *
   * @method startService
   *
   * @return {App} the app instance
  ...
  /*
   * the stop service phase is the phase that you stop everything you start. By default, we set it to stop the express server.
   *
   * @method stopService
   *
   * @return {App} the app instance
  ...
  /*
   * the start point of the app. it SHOULD NOT be overrided unless you know what you are doing
   *
   * @method start
   *
   * @return {App} the app instance
  ...
  /*
   * the stop point of the app. it SHOULD NOT be overrided unless you know what you are doing
   *
   * @method stop
   *
   * @return {App} the app instance
