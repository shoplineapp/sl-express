...
class App {
  ...
  async startExpress() {
    ...
    this.server.keepAliveTimeout = this.config.app.keep_alive_timeout

    console.log(`##### app listening to Port ${this.config.app.port}... keepAliveTimeout: ${this.server.keepAliveTimeout} #####`)
