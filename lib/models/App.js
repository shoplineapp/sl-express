...
class App {
  ...
  loadFramework() {
    ...
    this.services.Logger.sharedLogger.init(this.config.logger)

    Object.assign(this.context, this.models, this.services)
  ...
  loadModels() {
    ...
    const appModels = helper.loadRecursively(filePath, {
      required: false,
