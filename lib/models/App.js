...
class AppHelper {
  ...
  loadRecursively(filePath, options={}) {
  ...
  importDir(dirname, params={}) {
    ...
    files.forEach((file) => {
      ...
      if (fs.statSync(filepath).isDirectory()) {
        this.importDir(filepath, options)
      } else {
        try {
...
class App {
  ...
  loadConfig() {
    ...
    this.config = deepExtend({},
      helper.importDir(path.resolve(__dirname, '../config'), { required: false }),
  ...
  loadServices() {
    ...
    this.services = Object.assign({},
      helper.importDir(path.resolve(__dirname, '../services'), { required: false }),
  ...
  loadHelpers() {
    ...
    this.helpers = deepExtend({},
      helper.importDir(path.resolve(__dirname, '../helpers'), { required: false }),
