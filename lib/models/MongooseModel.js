 ...
 *
 * Please subclass this class when you use it.
 */

class MongooseModel {

  /*
   * part of the main logic of MongooseModel. Our App.js will call this load method if exist.
   *
...
//    schema.post('init', function(doc, next) { self.afterInit(doc, next) })
  ...
  /*
   * the getter method of the mongoose lib. This is the lazy loading pattern. It ensures the lib would not be required if the service is not used.
   *
   * @method mongoose
   *
  ...
  /*
   * the schema of the model. the object return will be directly port to the mongoose.
   * remember you can easily access the mongoose with this.mongoose
   *
   * @method schema
   *
